...
var star_set;
var blower;
var emptystar,onestar,twostar,displayall;
...
function setup() 
{
  ...
  star1.addImage(star_set);
  star1.scale=0.02;

  star2 = createSprite(50,370,20,20);
  star2.addImage(star_set);
  star2.scale=0.02;

  displayall = createSprite(50,20,30,30);
  displayall.scale = 0.2;
  displayall.addAnimation('empty',emptystar);
  displayall.addAnimation('one',onestar);
  displayall.addAnimation('two',twostar);
  displayall.changeAnimation('empty');
...
function draw() 
{
  ...
  if(collide(fruit,star1,20)==true){
    star1.visible = false
    displayall.changeAnimation('one');
  }
  if(collide(fruit,star2,20)==true){
    star2.visible = false    
    displayall.changeAnimation('two');
  }
